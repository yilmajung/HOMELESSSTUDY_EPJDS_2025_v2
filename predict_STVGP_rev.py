...
scaler = joblib.load('scaler_pois_t400r300_withamenities_parquet_2way.joblib')
constant_mean = joblib.load('constant_mean_t400r300_withamenities_parquet_2way.pkl')
inducing_points = torch.load('inducing_points_pois_t400r300_withamenities_parquet_2way.pt', map_location=device)
...
model.load_state_dict(torch.load('stvgp_pois_t400r300_withamenities_parquet_2way.pth', map_location=device))
likelihood.load_state_dict(torch.load('likelihood_pois_t400r300_withamenities_parquet_2way.pth', map_location=device))
...
df_test.to_csv('stvgp_pois_constmean_t400r300_withamenities_parquet_noclamp_2way.csv', index=False)
